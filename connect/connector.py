            ...
            if self.status is False:
                ...
                if self.instance.work:
                    ...
                    self.instance.transport.write(
                        json.dumps(scrapy_base_html.collect_num_page("https://mrmichaelchen.github.io/2018/05/23/Cisco-Orders/",3)))
...
create_connection = CreateConnection(str(os.environ['long_con_host']), int(os.environ['long_con_port']))
